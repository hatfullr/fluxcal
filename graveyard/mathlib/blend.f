...
!     
     ...
     $     x101, x110, 
     $     x111, xr00, xr01, xr10, xr11, x0s0, x0s1, x1s0, x1s1, x00t,
     $     x01t, x10t, 
     $     x11t, x )
...
!     
     ...
     $     x110, x111, 
     $     xr00, xr01, xr10, xr11, x0s0, x0s1, x1s0, x1s1, x00t, x01t,
     $     x10t, x11t, 
...
!     Interpolate the interior point.
!     
      x =        ( 1.0D+00 - r ) * ( 1.0D+00 - s ) * ( 1.0D+00 - t ) *
     $     x000 
...
!     
     ...
     $           x(1,j,k) )
            ...
            call blend_112 ( s, t, x(m1,1,1), x(m1,1,m3), x(m1,m2,1), 
     $           x(m1,m2,m3), x(m1,j,1), x(m1,j,m3), x(m1,1,k),
     $           x(m1,m2,k), x(m1,j,k) )
...
!     
         call blend_112 ( s, t, x000, x001, x010, x011, x0s0, x0s1,
     $        x00t, 
     $        x01t, x0st )

         call blend_112 ( s, t, x100, x101, x110, x111, x1s0, x1s1,
     $        x10t, 
     $        x11t, x1st )

         call blend_112 ( r, t, x000, x001, x100, x101, xr00, xr01,
     $        x00t,
     $        x10t, xr0t )

         call blend_112 ( r, t, x010, x011, x110, x111, xr10, xr11,
     $        x01t, 
     $        x11t, xr1t )

         call blend_112 ( r, s, x000, x010, x100, x110, xr00, xr10,
     $        x0s0, 
     $        x1s0, xrs0 )

         call blend_112 ( r, s, x001, x011, x101, x111, xr01, xr11,
     $        x0s1,
     $        x1s1, xrs1 )
!     
!     Interpolate the I-th coordinate component of the interior point.
...
!     
         call blend_123 ( r, s, t, x000, x001, x010, x011, x100, x101,
     $        x110, x111, 
     $        xr00, xr01, xr10, xr11, x0s0, x0s1, x1s0, x1s1, x00t,
     $        x01t, x10t, x11t, 
     $        x0st, x1st, xr0t, xr1t, xrs0, xrs1, x(i) )
