...
!     
     ...
     $     matmul ( p_data(1:m,1:data_num),
     $     l_interp(1:data_num,1:interp_num) )
...
!     
      ...
      if ( .not. r8vec_ascends_strictly ( data_num, t_data ) ) then
         ...
         write ( *, '(a)' )
     $        '  Independent variable array T_DATA is not'//
     $        ' strictly increasing.'
         stop 1
      end if
...
!     
     ...
     $              * ( t_interp(1:interp_num) - t_data(j) ) /
     $              ( t_data(i) - t_data(j) )
