...
CU    USES derivs
      INTEGER i
      real*8 ak2(intNMAX),ak3(intNMAX),ak4(intNMAX),ak5(intNMAX),
     $     ak6(intNMAX),ytemp(intNMAX),A2,A3,A4,A5,A6,B21,B31,B32,B41,
     $     B42,B43,B51,B52,B53,B54,B61,B62,B63,B64,B65,C1,C3,C4,C6,DC1,
     $     DC3,DC4,DC5,DC6
